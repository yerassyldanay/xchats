...
http://localhost:8081 ашыңыз және әдепкі әкімші аккаунтымен кіріңіз:
...
Кіргеннен кейін алғашқы баптау шебері сізді LLM провайдерінің API кілтін
қосуға, содан соң QR код арқылы WhatsApp нөмірін қосу үшін **Accounts →
add** бөліміне, немесе Telegram ботын қосу үшін **Settings → Integrations**
бөліміне бастайды.
