...
func (s *Server) Router() *gin.Engine {
	...
	pg.POST("/draft/specialists", s.handlePlaygroundUpsertSpecialist)
	pg.DELETE("/draft/specialists/:ref", s.handlePlaygroundDeleteSpecialist)
	pg.POST("/draft/services", s.handlePlaygroundUpsertService)
	pg.DELETE("/draft/services/:ref", s.handlePlaygroundDeleteService)
	pg.PATCH("/draft/contacts", s.handlePlaygroundPatchContacts)
	pg.PATCH("/draft/policies", s.handlePlaygroundPatchPolicies)
	pg.PATCH("/draft/tariff-info", s.handlePlaygroundPatchTariffInfo)
	...
	kb.PATCH("/tariff-info", s.handleKBPatchTariffInfo)
	kb.POST("/zones", s.handleKBUpsertZone)
	kb.DELETE("/zones/:ref", s.handleKBDeleteZone)
	kb.POST("/specialists", s.handleKBUpsertSpecialist)
	kb.DELETE("/specialists/:ref", s.handleKBDeleteSpecialist)
	kb.PATCH("/specialists/:ref/status", s.handleKBSpecialistStatus)
	kb.POST("/services", s.handleKBUpsertService)
	kb.DELETE("/services/:ref", s.handleKBDeleteService)
	kb.PATCH("/services/:ref/status", s.handleKBServiceStatus)
