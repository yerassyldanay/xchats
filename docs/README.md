...
Looking for the *design* record instead of operational docs? That's
[`plan/`](../plan/) — start at [`plan/README.md`](../plan/README.md).

Looking for how to contribute code? See [`CONTRIBUTING.md`](../CONTRIBUTING.md)
at the repo root.
