	...
	return []AITopic{
		{
			...
			Keywords: []string{"каталог", "ассортимент", "что есть", "товары"},
		...
		},
		{
			...
			Keywords: []string{"доставка", "привезти", "сроки", "стоимость доставки"},
		...
		},
		{
			...
			Keywords: []string{"оплата", "kaspi", "рассрочка", "карта"},
		...
		},
		{
			...
			Keywords: []string{"заказ", "оформить", "купить", "как купить"},
		...
		},
		{
			...
			Keywords: []string{"гарантия", "поломка", "ремонт", "сервис"},
		...
		},
		{
			...
			Keywords: []string{"возврат", "вернуть", "не подошло", "обмен"},
