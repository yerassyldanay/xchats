# Extraction eval — 2026-07-10 19:18
...
|---|---|---|---|
| openai/gpt-4o-mini | PASS (5/5 checks) | $0.00404 | all checks passed |
| anthropic/claude-haiku-4.5 | FAIL (4/5 checks) | unknown_pricing | failed: text_contains_all |
| google/gemini-2.5-flash | PASS (5/5 checks) | unknown_pricing | all checks passed |
...
| google/gemini-2.5-flash-lite | FAIL (5/7 checks) | $0.00029 | failed: identify_contains_all, no_invented_numbers |

**anthropic/claude-haiku-4.5 failures:**

- `identify_contains_all`: missing: llis
...
- `identify_contains_all`: missing: llis
- `no_invented_numbers`: not in the allowed list: 0000 0000
...
| Model | Result | Cost | Details |
|---|---|---|---|
| openai/gpt-4o-mini | FAIL (2/4 checks) | $0.00408 | failed: field:visibility_suggestion, text_contains_all |
