# Extraction eval — 2026-07-10 19:27
...
| google/gemini-2.5-flash-lite | PARSE FAILED | $0.00103 | unexpected end of JSON input |
...
| Model | Result | Cost | Details |
|---|---|---|---|
| openai/gpt-4o-mini | FAIL (3/4 checks) | $0.00408 | failed: text_contains_all |
