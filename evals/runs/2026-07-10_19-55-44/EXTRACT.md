# Extraction eval — 2026-07-10 19:58
...
|---|---|---|---|
| openai/gpt-4o-mini | FAIL (2/5 checks) | $0.00418 | failed: field:content_kind, text_contains_all, no_invented_numbers |
...
QR
Оформление заказа клиенте 24 500 ₸
Обсуждение QR с приложением Kaspi.kz
Deeplink
Заказ #A-2041
К оплате 24 500 ₸
...
Код подтверждения
•••••••
Kaspi Pay кассир теперь в купчике как виртуальный кассир
3 xpayment API
создание платежей
статусум
уведомления
...
| Model | Result | Cost | Details |
|---|---|---|---|
| openai/gpt-4o-mini | FAIL (3/5 checks) | $0.00418 | failed: text_contains_all, no_invented_numbers |
| anthropic/claude-haiku-4.5 | FAIL (3/5 checks) | unknown_pricing | failed: text_contains_all, no_invented_numbers |
| google/gemini-2.5-flash | FAIL (4/5 checks) | unknown_pricing | failed: no_invented_numbers |
| google/gemini-2.5-flash-lite | FAIL (3/5 checks) | $0.00056 | failed: field:content_kind, no_invented_numbers |

**openai/gpt-4o-mini failures:**

- `text_contains_all`: missing: кассир добавлен, 245 600, 77/7
...
Выберите точку продаж из списка, в котором вы хотите добавить кассира.
...
Роль:
Кассир
Кассир сможет принимать платежи и работать с продавцами.
...
- `text_contains_all`: missing: петров петр петрович, 77/7
...
Kaspi Pay
МП «Мой магазин»
Разход за категориям
245 600 ₸
Kaspi Пополнить счёткин
Счета на оплату
Точки продаж и кассиры
...
| google/gemini-2.5-flash-lite | FAIL (6/7 checks) | $0.00031 | failed: field:media_role_hint |
...
| Model | Result | Cost | Details |
|---|---|---|---|
| openai/gpt-4o-mini | FAIL (3/4 checks) | $0.00413 | failed: text_contains_all |
...
xPayment
Сервис автоматизации онлайн-платежей для бизнеса в Казахстане. Не банк, не платёжная организация, а партнер Kaspi.
...
xPayment — это веб-сервис автоматизации онлайн-платежей для предпринимателей. Мы не являемся банком, платежной организацией или официальным партнером АО «Касpi Банк». Денежные средства покупателей никогда не поступают на счета или карты xPayment — оплата уходит напрямую в торговую точку Пользователя в инфраструктуре Kaspi.
```
