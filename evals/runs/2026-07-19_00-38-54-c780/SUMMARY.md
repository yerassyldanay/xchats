# Run 2026-07-19_00-38-54-c780

Generated 2026-07-19 00:47. One table per scenario; a scenario's own README/PLAYGROUND.md
...
|---|---|---|---|---|---|---|---|
| openrouter:minimax/minimax-m2.5 | 21/29 (72%) | [54%, 85%] | 29/29 (100%) | $0.0211 est. (29 measured) | 9812ms | 2197 | 76% |
| openrouter:moonshotai/kimi-k2.5 | 24/29 (83%) | [65%, 92%] | 27/29 (93%) | $0.1221 est. (29 measured) | 53701ms | 3480 | 49% |

## Failures (verbatim)

**2. price question, Kazakh** | openrouter:minimax/minimax-m2.5
- message: Кофемашина DeLonghi қанша тұрады?
- reason: reply_language field is "kz", expected "kk"
- raw output: `

```json
{
  "reply_text": "Кофемашина DeLonghi құны — {{product.coffee-machine.price}}. Қазіргі уақытта ол қоймада бар. Тауарды қарап көргіңіз келсе, фотосуреттерін жіберіп бере аламын. Тапсырыс беруге дайынсыз ба?",
  "reply_language": "kz",
...
- raw output: ````json
{
  "reply_text": "Здравствуйте! Отлично, рады, что решили взять кофемашину DeLonghi — она {{product.coffee-machine.availability}} и стоит {{product.coffee-machine.price}}. Для оформления заказа: 1) укажите адрес доставки; 2) подтвердите заказ — мы пришлём счёт и оформим доставку прямо в Wha…`
