...
import type {
  ContactRow, DeliveryZoneRow, DraftChangeSet, DraftView, PolicyRow, ProductRow, ServiceRow, SpecialistRow, TariffInfoRow, TariffRow, TopicRow,
} from '@/types'

export type ChangeKind = 'topics' | 'tariffs' | 'products' | 'specialists' | 'services' | 'contacts' | 'policies' | 'tariff_info' | 'delivery_zones' | 'config'
...
export type KbRow = TopicRow | TariffRow | ProductRow | SpecialistRow | ServiceRow | ContactRow | PolicyRow | TariffInfoRow | DeliveryZoneRow
