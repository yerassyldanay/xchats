...
export default {
  ...
  kb: {
    ...
    page: {
      ...
      importTab: 'Import',
      importHint: 'Submit links or files — the model will process them and propose Draft entries for review.',
    },
    forms: {
      save: 'Save',
      cancel: 'Cancel',
    ...
    import: {
      ...
      dialog: {
        ...
        summary: 'To submit: {files} file(s), {urls} URL(s).',
      ...
      providers: {
        native: 'Built-in (pages and DOCX)',
        firecrawl: 'Firecrawl',
  ...
  settings: {
    ...
    aiEngine: {
      ...
      extractionTitle: 'Content extraction for import',
      extractionHint: 'Used by the structured knowledge base import (the "Import" tab) to read pages, PDFs, and other documents — separate from the response provider above.',
    },
    monitoring: {
