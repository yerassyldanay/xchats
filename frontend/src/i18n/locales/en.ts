...
export default {
  ...
  landing: {
    ...
    desktop: {
      ...
      winPortableExe: 'xchats.exe (portable)',
      winDesc: 'Installer. Pick the install folder, get Start Menu and desktop shortcuts, and a clean uninstaller — no administrator rights needed.',
      macTitle: 'macOS',
      macInstallerExe: 'xchats-desktop-macos-universal.dmg',
      macPortableExe: 'xchats.app (portable)',
      macDesc: 'Universal disk image, native on Apple Silicon (M1/M2/M3/M4) and Intel Macs. Open it and drag xchats to /Applications.',
      linuxTitle: 'Linux',
      linuxInstallerExe: 'xchats-desktop-linux-amd64.deb',
      linuxPortableExe: 'xchats (portable)',
      linuxDesc: 'Debian/Ubuntu package. Installs to /usr/bin and adds it to your application menu: sudo apt install ./xchats-desktop-linux-amd64.deb',
      downloadCta: 'Download',
      portableCta: 'or the portable archive:',
