...
export default {
  ...
  campaigns: {
    ...
    wizard: {
      title: 'New campaign',
      stepDetails: 'Campaign details',
      stepRecipients: 'Recipients & schedule',
      continueButton: 'Continue to Recipients →',
      ...
      customVariablePlaceholder: 'variable_name',
      ...
      recipientsHint: 'Paste a list, or upload a .csv/.txt file — one recipient per row.',
      ...
      scheduleAtLabel: 'Scheduled time',
