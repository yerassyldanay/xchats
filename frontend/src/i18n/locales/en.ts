...
export default {
  ...
  landing: {
    ...
    platforms: {
      ...
      tgTitle: 'Telegram',
      tgBadge: 'Free',
      tgDesc: 'Bot API — paste a token from @BotFather. No public URL required: the bot can run on polling.',
    ...
    templates: {
      ...
      sentence: 'The DeLonghi coffee machine costs {price}. Delivery to Astana — {days}.',
