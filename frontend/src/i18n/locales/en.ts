...
export default {
  ...
  landing: {
    ...
    hero: {
      ...
      titlePrefix: 'The self-hosted omnichannel inbox with',
      titleHighlight: 'zero-hallucination AI',
      titleSuffix: '',
      subtitle:
      ...
      screenshotAlt: 'The xchats team inbox with an AI-drafted reply awaiting approval',
      quickstartHint: 'Then open http://localhost:8081 — see the visual tour below.',
    },
    platforms: {
      eyebrow: 'PLATFORMS',
    ...
    showcase: {
      ...
      title: 'One product, five real screens',
      description: 'Every panel below is a real screenshot from a running instance seeded with make seed-demo, not a mockup.',
      ...
      crmTab: 'Mini CRM & Follow-ups',
      crmDesc: 'A lightweight customer profile and a time-grouped follow-up board — Overdue, Today, Tomorrow, Later.',
      crmAlt: 'The Follow-ups board grouped by Overdue, Today, Tomorrow and Later',
      mcpTab: 'MCP & Simulator',
      mcpDesc: 'Test the assistant risk-free in the Simulator, or let ChatGPT and Claude stage knowledge-base edits over MCP.',
      mcpAlt: 'The Simulator, testing the assistant with no live channel attached',
    },
    architecture: {
      eyebrow: 'ARCHITECTURE',
      title: 'Deliberately boring infrastructure',
      description: 'No cluster to operate, no vendor lock-in, no model you are forced to trust.',
      binaryTitle: 'Single Go binary + embedded SQLite',
      binaryDesc: 'No Postgres, no Redis, no managed database. Back it up by copying one file.',
      privacyTitle: 'Privacy-first, self-hosted',
      privacyDesc: 'Runs on your own server or laptop. Customer data never leaves infrastructure you control.',
      modelTitle: 'Model-agnostic',
      modelDesc: 'OpenAI, Claude, Gemini, OpenRouter or a local Ollama model — change providers from Settings, not code.',
    },
    how: {
      title: 'How it works',
