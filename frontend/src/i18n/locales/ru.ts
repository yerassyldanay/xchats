...
export default {
  ...
  landing: {
    ...
    desktop: {
      ...
      winTitle: 'Windows',
      winExe: 'xchats.exe',
      winDesc: 'Портативный исполняемый файл. Распакуйте и запустите. Без установщика, без Docker, без изменений в реестре — данные аккуратно хранятся в AppData.',
      macTitle: 'macOS',
      macExe: 'xchats.app',
      macDesc: 'Универсальная сборка, нативно работает и на Apple Silicon (M1/M2/M3/M4), и на Intel Mac. Перетащите в /Applications.',
      linuxTitle: 'Linux',
      linuxExe: 'xchats',
      linuxDesc: 'Один самодостаточный ELF-бинарник. Нативно работает на Ubuntu 24.04+, Debian 13+ и Fedora 39+.',
      downloadCta: 'Скачать',
