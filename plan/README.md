...
| [`url-import.md`](url-import.md) | Importing a web URL into `kbd_draft`: Fetch/Puppeteer MCP rendering, the image-to-`kbd_materials` pipeline, LLM schema mapping. | Not implemented — an implementation plan, including two amendments it proposes to `DECISIONS.md` and `mcp.md`. |
